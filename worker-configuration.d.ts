/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bdeccc5c8ba2e753a87a64f6fa53ad39)
...
interface __BaseEnv_Env {
	...
	INBOX_FORWARD_TO: "";
	CODE_MODE_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").CodeModeAgent>;
	BROWSER_HITL_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").BrowserHitlAgent>;
	WORKFLOWS_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").WorkflowsAgent>;
	ARTIFACT_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").ArtifactAgent>;
	CHAT_BROKER: DurableObjectNamespace<import("./dist/_worker.js/index").ChatBroker>;
	NOTIFICATIONS_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").NotificationsAgent>;
	ORCHESTRATOR_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").OrchestratorAgent>;
	RESEARCHER_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").ResearcherAgent>;
	CODER_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").CoderAgent>;
	MCP_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").McpAgent>;
	THINKING_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").ThinkingAgent>;
	SKILLS_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").SkillsAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker.js/index");
		durableNamespaces: "CodeModeAgent" | "BrowserHitlAgent" | "WorkflowsAgent" | "ArtifactAgent" | "ChatBroker" | "NotificationsAgent" | "OrchestratorAgent" | "ResearcherAgent" | "CoderAgent" | "McpAgent" | "ThinkingAgent" | "SkillsAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "MODEL_CHAT" | "MODEL_EXTRACT" | "MODEL_DRAFT" | "MODEL_TRANSCRIBE" | "DEFAULT_MODEL_EMBEDDING" | "INBOX_FORWARD_TO">> {}
}
